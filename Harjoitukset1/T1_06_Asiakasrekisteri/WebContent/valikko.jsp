...
<form name="kirjaudu_ulos" method="post" action="ServletLoginUlos">
	<a href='AsiakkaatServlet'>Asiakkaat</a> | <a href='lisaaAsiakas.jsp'>Lisää
		asiakas</a> | <a href='MapCreateServlet'>Poista asiakas</a> | <input
		type="submit" name="Submit" value="Kirjaudu ulos">
</form>

<form name="hae_tietueita" method="post" action="AsiakkaatHakuServlet">
